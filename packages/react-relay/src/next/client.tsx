...
export const createWunderGraphRelayClientApp = ({ client }: CreateWunderGraphRelayOptions) => {
	...
	function wunderGraphRelayClientWrapper<T>(Comp: ComponentType<T>): FC<{ initialRecords: RecordMap } & T> {
		return ({ initialRecords, ...props }: { initialRecords: RecordMap } & T) => (
