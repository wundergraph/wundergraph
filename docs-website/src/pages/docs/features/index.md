...
{% quick-link title="TypeScript Operations" icon="core" href="/docs/features/typescript-operations" description="TypeScript Operations allow you to extend your WunderGraph Application with custom Operations, purely written in TypeScript" /%}
