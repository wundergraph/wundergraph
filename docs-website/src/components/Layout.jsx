...
const navigation = [
	...
	},
	{
		...
		links: [
			{
				title: 'TypeScript hooks for custom business logic',
				href: '/features/typescript-hooks',
			},
			{ title: 'API Namespacing', href: '/features/api-namespacing' },
			{ title: 'Mocking', href: '/features/mocking' },
			{ title: 'Local Development', href: '/features/local-development' },
			{ title: 'Authentication', href: '/features/authentication' },
			{
				title: 'Authentication-aware Data-Fetching',
				href: '/features/authentication-aware-data-fetching',
			},
			{
				title: 'Authorization: Injecting Claims',
				href: '/features/authorization-injecting-claims',
			},
			{
				title: 'Authorization: Role-Based Access Control',
				href: '/features/authorization-role-based-access-control',
			},
			{ title: 'CSRF Protection', href: '/features/csrf-protection' },
			{ title: 'Caching', href: '/features/caching' },
			{ title: 'JSON-RPC Compiler', href: '/features/json-rpc-compiler' },
			{
				title: 'Automatic Content Revalidation with ETags',
				href: '/features/automatic-content-revalidation-with-etags',
			},
			{
				title: 'Realtime Subscriptions',
				href: '/features/realtime-subscriptions',
			},
			{ title: 'Live Queries', href: '/features/live-queries' },
			{
				title: 'Generated Clients / SDKs',
				href: '/features/generated-clients-sdks',
			},
			{
				title: 'JSON-Schema Validation',
				href: '/features/json-schema-validation',
			},
			{ title: 'Database to API', href: '/features/database-to-api' },
			{
				title: 'File-based Operations',
				href: '/features/file-based-operations',
			},
			{
				title: 'Configuration as Code',
				href: '/features/configuration-as-code',
			},
			{
				title: 'File uploads to S3 Storages',
				href: '/features/file-uploads-to-s3-storages',
			},
			{ title: 'Cross-API Joins', href: '/features/cross-api-joins' },
		],
	},
	{
