export const NextLogo = (props) => {
	return (
		<svg fill="none" role="img" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			></path>
			<rect fill="url(#paint1_linear_1766_6633)" height="32" width="5.33333" x="51.1113" y="24"></rect>
			<defs>
				<radialGradient
					cx="0"
					cy="0"
