...
export function ThemeSelector(props) {
	...
	return (
		<Listbox as="div" value={selectedTheme || { value: 'dark' }} onChange={setSelectedTheme} {...props}>
			...
			<Listbox.Options className="-trangray-x-1/2 absolute top-full right-1/2 mt-3 w-36 space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-gray-800 dark:ring-white/5">
				{themes.map((theme) => (
					<Listbox.Option
						key={theme.value}
						value={theme}
