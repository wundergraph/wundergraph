...
import { unstable_serialize, SWRConfig, useSWRConfig } from 'swr';
...
export const getServerSideProps = async () => {
	const user = await client.query<OperationRequestOptions<'Dragons'>, DragonsResponseData>({
		operationName: 'Dragons',
	});
	...
	return {
		props: {
			fallback: {
				[unstable_serialize({ operationName: 'Dragons' })]: user.data || null,
			},
		},
	};
};
