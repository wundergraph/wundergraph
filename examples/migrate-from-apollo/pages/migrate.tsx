...
const Home: NextPage = () => {
	...
	c0-30.5,5.8-59.7,16.7-86.5L484.4,669l69-116.7l68.5,116.5l83.8-142.5H785C772,642.8,673.3,733.2,553.4,733.2z"
				...
				<p className="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto dark:text-slate-400">
					Instead of using the Apollo GraphQL client, you can use{' '}
					<code className="font-mono font-medium text-sky-500 dark:text-sky-400">
						<a className="text-cyan-400 hover:text-cyan-600" target="_blank" href="https://wundergraph.com">
							WunderGraph
						</a>
					</code>{' '}
					auto-generated HTTP client. This does not only simplify the development, it also avoids exposing your GraphQL
					server to the public (security) and allows you to use HTTP Caching (performance).
				</p>
			</div>
