...
var file_wundernode_config_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x68, 0x51, 0x4c, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xdb, 0x01,
	0x0a, 0x0f, 0x53, 0x33, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x12, 0x3c, 0x0a, 0x19, 0x6d, 0x61, 0x78, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x55,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01,
	...
	0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x6d, 0x61, 0x78, 0x41, 0x6c, 0x6c,
	0x6f, 0x77, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x2a, 0x0a, 0x10, 0x61, 0x6c, 0x6c,
	0x6f, 0x77, 0x65, 0x64, 0x4d, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x73, 0x18, 0x03, 0x20,
	...
	0x46, 0x69, 0x6c, 0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x15, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x46, 0x69, 0x6c,
	0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb7, 0x04, 0x0a, 0x15,
	...
	0x05, 0x46, 0x41, 0x54, 0x41, 0x4c, 0x10, 0x05, 0x2a, 0x40, 0x0a, 0x10, 0x41, 0x75, 0x74, 0x68,
	...
	0x69, 0x64, 0x65, 0x72, 0x4f, 0x49, 0x44, 0x43, 0x10, 0x01, 0x2a, 0x42, 0x0a, 0x0c, 0x41, 0x70,
	...
	0x0b, 0x52, 0x45, 0x44, 0x49, 0x53, 0x5f, 0x43, 0x41, 0x43, 0x48, 0x45, 0x10, 0x02, 0x2a, 0x44,
	...
	0x02, 0x2a, 0x76, 0x0a, 0x0e, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4b,
	...
	0x06, 0x53, 0x51, 0x4c, 0x49, 0x54, 0x45, 0x10, 0x07, 0x2a, 0x71, 0x0a, 0x1a, 0x55, 0x70, 0x73,
...
var file_wundernode_config_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_wundernode_config_proto_goTypes = []interface{}{
	...
	(*NodeLogging)(nil),                                      // 69: wgpb.NodeLogging
	(*NodeOptions)(nil),                                      // 70: wgpb.NodeOptions
	(*ServerLogging)(nil),                                    // 71: wgpb.ServerLogging
	(*ServerOptions)(nil),                                    // 72: wgpb.ServerOptions
	(*WebhookConfiguration)(nil),                             // 73: wgpb.WebhookConfiguration
	(*WebhookVerifier)(nil),                                  // 74: wgpb.WebhookVerifier
	(*CorsConfiguration)(nil),                                // 75: wgpb.CorsConfiguration
	(*ConfigurationVariable)(nil),                            // 76: wgpb.ConfigurationVariable
	nil,                                                      // 77: wgpb.FetchConfiguration.HeaderEntry
	nil,                                                      // 78: wgpb.S3UploadConfiguration.UploadProfilesEntry
}
var file_wundernode_config_proto_depIdxs = []int32{
	...
	76,  // 4: wgpb.JwksAuthProvider.jwksUrl:type_name -> wgpb.ConfigurationVariable
	76,  // 5: wgpb.JwksAuthProvider.jwksJson:type_name -> wgpb.ConfigurationVariable
	76,  // 6: wgpb.JwksAuthProvider.userInfoEndpoint:type_name -> wgpb.ConfigurationVariable
	20,  // 7: wgpb.CookieBasedAuthentication.providers:type_name -> wgpb.AuthProvider
	76,  // 8: wgpb.CookieBasedAuthentication.authorizedRedirectUris:type_name -> wgpb.ConfigurationVariable
	76,  // 9: wgpb.CookieBasedAuthentication.authorizedRedirectUriRegexes:type_name -> wgpb.ConfigurationVariable
	76,  // 10: wgpb.CookieBasedAuthentication.hashKey:type_name -> wgpb.ConfigurationVariable
	76,  // 11: wgpb.CookieBasedAuthentication.blockKey:type_name -> wgpb.ConfigurationVariable
	76,  // 12: wgpb.CookieBasedAuthentication.csrfSecret:type_name -> wgpb.ConfigurationVariable
	...
	76,  // 16: wgpb.GithubAuthProviderConfig.clientId:type_name -> wgpb.ConfigurationVariable
	76,  // 17: wgpb.GithubAuthProviderConfig.clientSecret:type_name -> wgpb.ConfigurationVariable
	76,  // 18: wgpb.OpenIDConnectQueryParameter.name:type_name -> wgpb.ConfigurationVariable
	76,  // 19: wgpb.OpenIDConnectQueryParameter.value:type_name -> wgpb.ConfigurationVariable
	76,  // 20: wgpb.OpenIDConnectAuthProviderConfig.issuer:type_name -> wgpb.ConfigurationVariable
	76,  // 21: wgpb.OpenIDConnectAuthProviderConfig.clientId:type_name -> wgpb.ConfigurationVariable
	76,  // 22: wgpb.OpenIDConnectAuthProviderConfig.clientSecret:type_name -> wgpb.ConfigurationVariable
	...
	76,  // 62: wgpb.DataSourceCustom_Database.databaseURL:type_name -> wgpb.ConfigurationVariable
	62,  // 63: wgpb.DataSourceCustom_Database.jsonTypeFields:type_name -> wgpb.SingleTypeField
	76,  // 64: wgpb.DataSourceCustom_Static.data:type_name -> wgpb.ConfigurationVariable
	76,  // 65: wgpb.GraphQLSubscriptionConfiguration.url:type_name -> wgpb.ConfigurationVariable
	76,  // 66: wgpb.FetchConfiguration.url:type_name -> wgpb.ConfigurationVariable
	10,  // 67: wgpb.FetchConfiguration.method:type_name -> wgpb.HTTPMethod
	77,  // 68: wgpb.FetchConfiguration.header:type_name -> wgpb.FetchConfiguration.HeaderEntry
	76,  // 69: wgpb.FetchConfiguration.body:type_name -> wgpb.ConfigurationVariable
	...
	76,  // 73: wgpb.FetchConfiguration.baseUrl:type_name -> wgpb.ConfigurationVariable
	76,  // 74: wgpb.FetchConfiguration.path:type_name -> wgpb.ConfigurationVariable
	76,  // 75: wgpb.MTLSConfiguration.key:type_name -> wgpb.ConfigurationVariable
	76,  // 76: wgpb.MTLSConfiguration.cert:type_name -> wgpb.ConfigurationVariable
	...
	76,  // 80: wgpb.JwtUpstreamAuthenticationConfig.secret:type_name -> wgpb.ConfigurationVariable
	9,   // 81: wgpb.JwtUpstreamAuthenticationConfig.signingMethod:type_name -> wgpb.SigningMethod
	76,  // 82: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.secret:type_name -> wgpb.ConfigurationVariable
	9,   // 83: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.signingMethod:type_name -> wgpb.SigningMethod
	76,  // 84: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.accessTokenExchangeEndpoint:type_name -> wgpb.ConfigurationVariable
	76,  // 85: wgpb.HTTPHeader.values:type_name -> wgpb.ConfigurationVariable
	...
	67,  // 89: wgpb.WunderGraphConfiguration.api:type_name -> wgpb.UserDefinedApi
	76,  // 90: wgpb.S3UploadConfiguration.endpoint:type_name -> wgpb.ConfigurationVariable
	76,  // 91: wgpb.S3UploadConfiguration.accessKeyID:type_name -> wgpb.ConfigurationVariable
	76,  // 92: wgpb.S3UploadConfiguration.secretAccessKey:type_name -> wgpb.ConfigurationVariable
	76,  // 93: wgpb.S3UploadConfiguration.bucketName:type_name -> wgpb.ConfigurationVariable
	76,  // 94: wgpb.S3UploadConfiguration.bucketLocation:type_name -> wgpb.ConfigurationVariable
	78,  // 95: wgpb.S3UploadConfiguration.uploadProfiles:type_name -> wgpb.S3UploadConfiguration.UploadProfilesEntry
	41,  // 96: wgpb.UserDefinedApi.engineConfiguration:type_name -> wgpb.EngineConfiguration
	27,  // 97: wgpb.UserDefinedApi.operations:type_name -> wgpb.Operation
	75,  // 98: wgpb.UserDefinedApi.corsConfiguration:type_name -> wgpb.CorsConfiguration
	15,  // 99: wgpb.UserDefinedApi.authenticationConfig:type_name -> wgpb.ApiAuthenticationConfig
	66,  // 100: wgpb.UserDefinedApi.s3UploadConfiguration:type_name -> wgpb.S3UploadConfiguration
	76,  // 101: wgpb.UserDefinedApi.allowedHostNames:type_name -> wgpb.ConfigurationVariable
	73,  // 102: wgpb.UserDefinedApi.webhooks:type_name -> wgpb.WebhookConfiguration
	72,  // 103: wgpb.UserDefinedApi.serverOptions:type_name -> wgpb.ServerOptions
	70,  // 104: wgpb.UserDefinedApi.nodeOptions:type_name -> wgpb.NodeOptions
	76,  // 105: wgpb.ListenerOptions.host:type_name -> wgpb.ConfigurationVariable
	76,  // 106: wgpb.ListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	76,  // 107: wgpb.NodeLogging.level:type_name -> wgpb.ConfigurationVariable
	76,  // 108: wgpb.NodeOptions.nodeUrl:type_name -> wgpb.ConfigurationVariable
	76,  // 109: wgpb.NodeOptions.publicNodeUrl:type_name -> wgpb.ConfigurationVariable
	68,  // 110: wgpb.NodeOptions.listen:type_name -> wgpb.ListenerOptions
	69,  // 111: wgpb.NodeOptions.logger:type_name -> wgpb.NodeLogging
	76,  // 112: wgpb.ServerLogging.level:type_name -> wgpb.ConfigurationVariable
	76,  // 113: wgpb.ServerOptions.serverUrl:type_name -> wgpb.ConfigurationVariable
	68,  // 114: wgpb.ServerOptions.listen:type_name -> wgpb.ListenerOptions
	71,  // 115: wgpb.ServerOptions.logger:type_name -> wgpb.ServerLogging
	74,  // 116: wgpb.WebhookConfiguration.verifier:type_name -> wgpb.WebhookVerifier
	13,  // 117: wgpb.WebhookVerifier.kind:type_name -> wgpb.WebhookVerifierKind
	76,  // 118: wgpb.WebhookVerifier.secret:type_name -> wgpb.ConfigurationVariable
	76,  // 119: wgpb.CorsConfiguration.allowedOrigins:type_name -> wgpb.ConfigurationVariable
	14,  // 120: wgpb.ConfigurationVariable.kind:type_name -> wgpb.ConfigurationVariableKind
	58,  // 121: wgpb.FetchConfiguration.HeaderEntry.value:type_name -> wgpb.HTTPHeader
	65,  // 122: wgpb.S3UploadConfiguration.UploadProfilesEntry.value:type_name -> wgpb.S3UploadProfile
