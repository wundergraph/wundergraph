...
type S3UploadProfile struct {
	...
	Hooks                     *S3UploadProfileHooksConfiguration `protobuf:"bytes,5,opt,name=hooks,proto3" json:"hooks,omitempty"`
}
...
var file_wundernode_config_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x68, 0x51, 0x4c, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x41, 0x0a,
	...
	0x22, 0x9a, 0x02, 0x0a, 0x0f, 0x53, 0x33, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x12, 0x3c, 0x0a, 0x19, 0x6d, 0x61, 0x78, 0x41, 0x6c, 0x6c, 0x6f, 0x77,
	0x65, 0x64, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x19, 0x6d, 0x61, 0x78, 0x41, 0x6c, 0x6c, 0x6f,
	...
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x6d, 0x61, 0x78,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x4d,
	...
	0x46, 0x69, 0x6c, 0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3d,
	0x0a, 0x05, 0x68, 0x6f, 0x6f, 0x6b, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e,
	...
	0x09, 0x0a, 0x05, 0x46, 0x41, 0x54, 0x41, 0x4c, 0x10, 0x05, 0x2a, 0x40, 0x0a, 0x10, 0x41, 0x75,
	...
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x4f, 0x49, 0x44, 0x43, 0x10, 0x01, 0x2a, 0x42, 0x0a, 0x0c,
	0x41, 0x70, 0x69, 0x43, 0x61, 0x63, 0x68, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x0c, 0x0a, 0x08,
	0x4e, 0x4f, 0x5f, 0x43, 0x41, 0x43, 0x48, 0x45, 0x10, 0x00, 0x12, 0x13, 0x0a, 0x0f, 0x49, 0x4e,
	0x5f, 0x4d, 0x45, 0x4d, 0x4f, 0x52, 0x59, 0x5f, 0x43, 0x41, 0x43, 0x48, 0x45, 0x10, 0x01, 0x12,
	0x0f, 0x0a, 0x0b, 0x52, 0x45, 0x44, 0x49, 0x53, 0x5f, 0x43, 0x41, 0x43, 0x48, 0x45, 0x10, 0x02,
	...
	0x53, 0x45, 0x52, 0x49, 0x44, 0x10, 0x06, 0x2a, 0x3a, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	0x4e, 0x10, 0x02, 0x2a, 0x76, 0x0a, 0x0e, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x0a, 0x0a, 0x06, 0x53, 0x51, 0x4c, 0x49, 0x54, 0x45, 0x10, 0x07, 0x2a, 0x71, 0x0a, 0x1a, 0x55,
...
var file_wundernode_config_proto_goTypes = []interface{}{
	...
	nil,                                                      // 78: wgpb.FetchConfiguration.HeaderEntry
	nil,                                                      // 79: wgpb.S3UploadConfiguration.UploadProfilesEntry
}
var file_wundernode_config_proto_depIdxs = []int32{
	...
	78,  // 68: wgpb.FetchConfiguration.header:type_name -> wgpb.FetchConfiguration.HeaderEntry
	...
	77,  // 75: wgpb.MTLSConfiguration.key:type_name -> wgpb.ConfigurationVariable
	77,  // 76: wgpb.MTLSConfiguration.cert:type_name -> wgpb.ConfigurationVariable
	...
	77,  // 80: wgpb.JwtUpstreamAuthenticationConfig.secret:type_name -> wgpb.ConfigurationVariable
	9,   // 81: wgpb.JwtUpstreamAuthenticationConfig.signingMethod:type_name -> wgpb.SigningMethod
	77,  // 82: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.secret:type_name -> wgpb.ConfigurationVariable
	9,   // 83: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.signingMethod:type_name -> wgpb.SigningMethod
	77,  // 84: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.accessTokenExchangeEndpoint:type_name -> wgpb.ConfigurationVariable
	77,  // 85: wgpb.HTTPHeader.values:type_name -> wgpb.ConfigurationVariable
	...
	68,  // 89: wgpb.WunderGraphConfiguration.api:type_name -> wgpb.UserDefinedApi
	65,  // 90: wgpb.S3UploadProfile.hooks:type_name -> wgpb.S3UploadProfileHooksConfiguration
	77,  // 91: wgpb.S3UploadConfiguration.endpoint:type_name -> wgpb.ConfigurationVariable
	77,  // 92: wgpb.S3UploadConfiguration.accessKeyID:type_name -> wgpb.ConfigurationVariable
	77,  // 93: wgpb.S3UploadConfiguration.secretAccessKey:type_name -> wgpb.ConfigurationVariable
	77,  // 94: wgpb.S3UploadConfiguration.bucketName:type_name -> wgpb.ConfigurationVariable
	77,  // 95: wgpb.S3UploadConfiguration.bucketLocation:type_name -> wgpb.ConfigurationVariable
	79,  // 96: wgpb.S3UploadConfiguration.uploadProfiles:type_name -> wgpb.S3UploadConfiguration.UploadProfilesEntry
	41,  // 97: wgpb.UserDefinedApi.engineConfiguration:type_name -> wgpb.EngineConfiguration
	27,  // 98: wgpb.UserDefinedApi.operations:type_name -> wgpb.Operation
	76,  // 99: wgpb.UserDefinedApi.corsConfiguration:type_name -> wgpb.CorsConfiguration
	15,  // 100: wgpb.UserDefinedApi.authenticationConfig:type_name -> wgpb.ApiAuthenticationConfig
	67,  // 101: wgpb.UserDefinedApi.s3UploadConfiguration:type_name -> wgpb.S3UploadConfiguration
	77,  // 102: wgpb.UserDefinedApi.allowedHostNames:type_name -> wgpb.ConfigurationVariable
	74,  // 103: wgpb.UserDefinedApi.webhooks:type_name -> wgpb.WebhookConfiguration
	73,  // 104: wgpb.UserDefinedApi.serverOptions:type_name -> wgpb.ServerOptions
	71,  // 105: wgpb.UserDefinedApi.nodeOptions:type_name -> wgpb.NodeOptions
	77,  // 106: wgpb.ListenerOptions.host:type_name -> wgpb.ConfigurationVariable
	77,  // 107: wgpb.ListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	77,  // 108: wgpb.NodeLogging.level:type_name -> wgpb.ConfigurationVariable
	77,  // 109: wgpb.NodeOptions.nodeUrl:type_name -> wgpb.ConfigurationVariable
	77,  // 110: wgpb.NodeOptions.publicNodeUrl:type_name -> wgpb.ConfigurationVariable
	69,  // 111: wgpb.NodeOptions.listen:type_name -> wgpb.ListenerOptions
	70,  // 112: wgpb.NodeOptions.logger:type_name -> wgpb.NodeLogging
	77,  // 113: wgpb.ServerLogging.level:type_name -> wgpb.ConfigurationVariable
	77,  // 114: wgpb.ServerOptions.serverUrl:type_name -> wgpb.ConfigurationVariable
	69,  // 115: wgpb.ServerOptions.listen:type_name -> wgpb.ListenerOptions
	72,  // 116: wgpb.ServerOptions.logger:type_name -> wgpb.ServerLogging
	75,  // 117: wgpb.WebhookConfiguration.verifier:type_name -> wgpb.WebhookVerifier
	13,  // 118: wgpb.WebhookVerifier.kind:type_name -> wgpb.WebhookVerifierKind
	77,  // 119: wgpb.WebhookVerifier.secret:type_name -> wgpb.ConfigurationVariable
	77,  // 120: wgpb.CorsConfiguration.allowedOrigins:type_name -> wgpb.ConfigurationVariable
	14,  // 121: wgpb.ConfigurationVariable.kind:type_name -> wgpb.ConfigurationVariableKind
	58,  // 122: wgpb.FetchConfiguration.HeaderEntry.value:type_name -> wgpb.HTTPHeader
	66,  // 123: wgpb.S3UploadConfiguration.UploadProfilesEntry.value:type_name -> wgpb.S3UploadProfile
