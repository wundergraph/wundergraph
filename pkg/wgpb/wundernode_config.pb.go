...
var file_wundernode_config_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x72, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x54, 0x6f, 0x22, 0xb7, 0x02, 0x0a, 0x17,
	0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x5f, 0x4e, 0x61, 0x74, 0x73, 0x4b, 0x76, 0x12, 0x39, 0x0a, 0x09, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x55, 0x52, 0x4c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x77, 0x67, 0x70,
	0x62, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56,
	...
	,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x54, 0x6f, 0x22, 0xad, 0x02, 0x0a, 0x18, 0x57,
	...
	0x65, 0x64, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0xe1, 0x01, 0x0a, 0x0f, 0x45,
	...
	0x42, 0x53, 0x43, 0x52, 0x49, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x02, 0x2a, 0x8e, 0x01, 0x0a,
...
var file_wundernode_config_proto_depIdxs = []int32{
	...
	84,  // 57: wgpb.DataSourceCustom_NatsKv.serverURL:type_name -> wgpb.ConfigurationVariable
	9,   // 58: wgpb.DataSourceCustom_NatsKv.operation:type_name -> wgpb.NatsKvOperation
	84,  // 59: wgpb.DataSourceCustom_NatsKv.token:type_name -> wgpb.ConfigurationVariable
	84,  // 60: wgpb.DataSourceCustom_NatsKv.bucketPrefix:type_name -> wgpb.ConfigurationVariable
	53,  // 61: wgpb.DataSourceCustom_REST.fetch:type_name -> wgpb.FetchConfiguration
	58,  // 62: wgpb.DataSourceCustom_REST.subscription:type_name -> wgpb.RESTSubscriptionConfiguration
	47,  // 63: wgpb.DataSourceCustom_REST.statusCodeTypeMappings:type_name -> wgpb.StatusCodeTypeMapping
	53,  // 64: wgpb.DataSourceCustom_GraphQL.fetch:type_name -> wgpb.FetchConfiguration
	52,  // 65: wgpb.DataSourceCustom_GraphQL.subscription:type_name -> wgpb.GraphQLSubscriptionConfiguration
	50,  // 66: wgpb.DataSourceCustom_GraphQL.federation:type_name -> wgpb.GraphQLFederationConfiguration
	42,  // 67: wgpb.DataSourceCustom_GraphQL.upstreamSchema:type_name -> wgpb.InternedString
	31,  // 68: wgpb.DataSourceCustom_GraphQL.hooksConfiguration:type_name -> wgpb.GraphQLDataSourceHooksConfiguration
	64,  // 69: wgpb.DataSourceCustom_GraphQL.customScalarTypeFields:type_name -> wgpb.SingleTypeField
	84,  // 70: wgpb.DataSourceCustom_Database.databaseURL:type_name -> wgpb.ConfigurationVariable
	42,  // 71: wgpb.DataSourceCustom_Database.prismaSchema:type_name -> wgpb.InternedString
	42,  // 72: wgpb.DataSourceCustom_Database.graphqlSchema:type_name -> wgpb.InternedString
	64,  // 73: wgpb.DataSourceCustom_Database.jsonTypeFields:type_name -> wgpb.SingleTypeField
	84,  // 74: wgpb.DataSourceCustom_Static.data:type_name -> wgpb.ConfigurationVariable
	84,  // 75: wgpb.GraphQLSubscriptionConfiguration.url:type_name -> wgpb.ConfigurationVariable
	84,  // 76: wgpb.FetchConfiguration.url:type_name -> wgpb.ConfigurationVariable
	12,  // 77: wgpb.FetchConfiguration.method:type_name -> wgpb.HTTPMethod
	90,  // 78: wgpb.FetchConfiguration.header:type_name -> wgpb.FetchConfiguration.HeaderEntry
	84,  // 79: wgpb.FetchConfiguration.body:type_name -> wgpb.ConfigurationVariable
	59,  // 80: wgpb.FetchConfiguration.query:type_name -> wgpb.URLQueryConfiguration
	55,  // 81: wgpb.FetchConfiguration.upstreamAuthentication:type_name -> wgpb.UpstreamAuthentication
	54,  // 82: wgpb.FetchConfiguration.mTLS:type_name -> wgpb.MTLSConfiguration
	84,  // 83: wgpb.FetchConfiguration.baseUrl:type_name -> wgpb.ConfigurationVariable
	84,  // 84: wgpb.FetchConfiguration.path:type_name -> wgpb.ConfigurationVariable
	84,  // 85: wgpb.FetchConfiguration.httpProxyUrl:type_name -> wgpb.ConfigurationVariable
	84,  // 86: wgpb.MTLSConfiguration.key:type_name -> wgpb.ConfigurationVariable
	84,  // 87: wgpb.MTLSConfiguration.cert:type_name -> wgpb.ConfigurationVariable
	10,  // 88: wgpb.UpstreamAuthentication.kind:type_name -> wgpb.UpstreamAuthenticationKind
	56,  // 89: wgpb.UpstreamAuthentication.jwtConfig:type_name -> wgpb.JwtUpstreamAuthenticationConfig
	57,  // 90: wgpb.UpstreamAuthentication.jwtWithAccessTokenExchangeConfig:type_name -> wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange
	84,  // 91: wgpb.JwtUpstreamAuthenticationConfig.secret:type_name -> wgpb.ConfigurationVariable
	11,  // 92: wgpb.JwtUpstreamAuthenticationConfig.signingMethod:type_name -> wgpb.SigningMethod
	84,  // 93: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.secret:type_name -> wgpb.ConfigurationVariable
	11,  // 94: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.signingMethod:type_name -> wgpb.SigningMethod
	84,  // 95: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.accessTokenExchangeEndpoint:type_name -> wgpb.ConfigurationVariable
	84,  // 96: wgpb.HTTPHeader.values:type_name -> wgpb.ConfigurationVariable
	65,  // 97: wgpb.FieldConfiguration.argumentsConfiguration:type_name -> wgpb.ArgumentConfiguration
	13,  // 98: wgpb.ArgumentConfiguration.sourceType:type_name -> wgpb.ArgumentSource
	14,  // 99: wgpb.ArgumentConfiguration.renderConfiguration:type_name -> wgpb.ArgumentRenderConfiguration
	71,  // 100: wgpb.WunderGraphConfiguration.api:type_name -> wgpb.UserDefinedApi
	67,  // 101: wgpb.WunderGraphConfiguration.enabledFeatures:type_name -> wgpb.EnabledFeatures
	68,  // 102: wgpb.S3UploadProfile.hooks:type_name -> wgpb.S3UploadProfileHooksConfiguration
	84,  // 103: wgpb.S3UploadConfiguration.endpoint:type_name -> wgpb.ConfigurationVariable
	84,  // 104: wgpb.S3UploadConfiguration.accessKeyID:type_name -> wgpb.ConfigurationVariable
	84,  // 105: wgpb.S3UploadConfiguration.secretAccessKey:type_name -> wgpb.ConfigurationVariable
	84,  // 106: wgpb.S3UploadConfiguration.bucketName:type_name -> wgpb.ConfigurationVariable
	84,  // 107: wgpb.S3UploadConfiguration.bucketLocation:type_name -> wgpb.ConfigurationVariable
	91,  // 108: wgpb.S3UploadConfiguration.uploadProfiles:type_name -> wgpb.S3UploadConfiguration.UploadProfilesEntry
	41,  // 109: wgpb.UserDefinedApi.engineConfiguration:type_name -> wgpb.EngineConfiguration
	26,  // 110: wgpb.UserDefinedApi.operations:type_name -> wgpb.Operation
	83,  // 111: wgpb.UserDefinedApi.corsConfiguration:type_name -> wgpb.CorsConfiguration
	17,  // 112: wgpb.UserDefinedApi.authenticationConfig:type_name -> wgpb.ApiAuthenticationConfig
	70,  // 113: wgpb.UserDefinedApi.s3UploadConfiguration:type_name -> wgpb.S3UploadConfiguration
	84,  // 114: wgpb.UserDefinedApi.allowedHostNames:type_name -> wgpb.ConfigurationVariable
	81,  // 115: wgpb.UserDefinedApi.webhooks:type_name -> wgpb.WebhookConfiguration
	80,  // 116: wgpb.UserDefinedApi.serverOptions:type_name -> wgpb.ServerOptions
	77,  // 117: wgpb.UserDefinedApi.nodeOptions:type_name -> wgpb.NodeOptions
	72,  // 118: wgpb.UserDefinedApi.experimentalConfig:type_name -> wgpb.ExperimentalConfiguration
	84,  // 119: wgpb.ListenerOptions.host:type_name -> wgpb.ConfigurationVariable
	84,  // 120: wgpb.ListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	84,  // 121: wgpb.InternalListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	84,  // 122: wgpb.NodeLogging.level:type_name -> wgpb.ConfigurationVariable
	84,  // 123: wgpb.PrometheusOptions.enabled:type_name -> wgpb.ConfigurationVariable
	84,  // 124: wgpb.PrometheusOptions.port:type_name -> wgpb.ConfigurationVariable
	84,  // 125: wgpb.NodeOptions.nodeUrl:type_name -> wgpb.ConfigurationVariable
	84,  // 126: wgpb.NodeOptions.publicNodeUrl:type_name -> wgpb.ConfigurationVariable
	73,  // 127: wgpb.NodeOptions.listen:type_name -> wgpb.ListenerOptions
	75,  // 128: wgpb.NodeOptions.logger:type_name -> wgpb.NodeLogging
	74,  // 129: wgpb.NodeOptions.listenInternal:type_name -> wgpb.InternalListenerOptions
	84,  // 130: wgpb.NodeOptions.nodeInternalUrl:type_name -> wgpb.ConfigurationVariable
	84,  // 131: wgpb.NodeOptions.defaultHttpProxyUrl:type_name -> wgpb.ConfigurationVariable
	78,  // 132: wgpb.NodeOptions.openTelemetry:type_name -> wgpb.TelemetryOptions
	76,  // 133: wgpb.NodeOptions.prometheus:type_name -> wgpb.PrometheusOptions
	84,  // 134: wgpb.TelemetryOptions.enabled:type_name -> wgpb.ConfigurationVariable
	84,  // 135: wgpb.TelemetryOptions.exporterHttpEndpoint:type_name -> wgpb.ConfigurationVariable
	84,  // 136: wgpb.TelemetryOptions.sampler:type_name -> wgpb.ConfigurationVariable
	84,  // 137: wgpb.TelemetryOptions.authToken:type_name -> wgpb.ConfigurationVariable
	84,  // 138: wgpb.ServerLogging.level:type_name -> wgpb.ConfigurationVariable
	84,  // 139: wgpb.ServerOptions.serverUrl:type_name -> wgpb.ConfigurationVariable
	73,  // 140: wgpb.ServerOptions.listen:type_name -> wgpb.ListenerOptions
	79,  // 141: wgpb.ServerOptions.logger:type_name -> wgpb.ServerLogging
	82,  // 142: wgpb.WebhookConfiguration.verifier:type_name -> wgpb.WebhookVerifier
	15,  // 143: wgpb.WebhookVerifier.kind:type_name -> wgpb.WebhookVerifierKind
	84,  // 144: wgpb.WebhookVerifier.secret:type_name -> wgpb.ConfigurationVariable
	84,  // 145: wgpb.CorsConfiguration.allowedOrigins:type_name -> wgpb.ConfigurationVariable
	16,  // 146: wgpb.ConfigurationVariable.kind:type_name -> wgpb.ConfigurationVariableKind
	86,  // 147: wgpb.BuildInfo.sdk:type_name -> wgpb.BuildInfoVersion
	86,  // 148: wgpb.BuildInfo.wunderctl:type_name -> wgpb.BuildInfoVersion
	86,  // 149: wgpb.BuildInfo.node:type_name -> wgpb.BuildInfoVersion
	87,  // 150: wgpb.BuildInfo.os:type_name -> wgpb.BuildInfoOS
	88,  // 151: wgpb.BuildInfo.stats:type_name -> wgpb.BuildInfoStats
	60,  // 152: wgpb.FetchConfiguration.HeaderEntry.value:type_name -> wgpb.HTTPHeader
	69,  // 153: wgpb.S3UploadConfiguration.UploadProfilesEntry.value:type_name -> wgpb.S3UploadProfile
