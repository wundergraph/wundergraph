...
var file_wundernode_config_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x1b, 0x2e, 0x77, 0x67, 0x70, 0x62, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x04,
	0x70, 0x6f, 0x72, 0x74, 0x22, 0xfa, 0x01, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x4f, 0x70, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x06, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x12, 0x42, 0x0a,
	...
	0x73, 0x22, 0x79, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x06, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x22, 0x79, 0x0a, 0x14,
	...
	0x69, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x2a, 0x40, 0x0a, 0x10, 0x41, 0x75, 0x74,
...
var file_wundernode_config_proto_enumTypes = make([]protoimpl.EnumInfo, 14)
...
var file_wundernode_config_proto_goTypes = []interface{}{
	(AuthProviderKind)(0),                                    // 0: wgpb.AuthProviderKind
	(ApiCacheKind)(0),                                        // 1: wgpb.ApiCacheKind
	(PostResolveTransformationKind)(0),                       // 2: wgpb.PostResolveTransformationKind
	(InjectVariableKind)(0),                                  // 3: wgpb.InjectVariableKind
	(Claim)(0),                                               // 4: wgpb.Claim
	(OperationType)(0),                                       // 5: wgpb.OperationType
	(DataSourceKind)(0),                                      // 6: wgpb.DataSourceKind
	(UpstreamAuthenticationKind)(0),                          // 7: wgpb.UpstreamAuthenticationKind
	(SigningMethod)(0),                                       // 8: wgpb.SigningMethod
	(HTTPMethod)(0),                                          // 9: wgpb.HTTPMethod
	(ArgumentSource)(0),                                      // 10: wgpb.ArgumentSource
	(ArgumentRenderConfiguration)(0),                         // 11: wgpb.ArgumentRenderConfiguration
	(WebhookVerifierKind)(0),                                 // 12: wgpb.WebhookVerifierKind
	(ConfigurationVariableKind)(0),                           // 13: wgpb.ConfigurationVariableKind
	(*ApiAuthenticationConfig)(nil),                          // 14: wgpb.ApiAuthenticationConfig
	(*JwksBasedAuthentication)(nil),                          // 15: wgpb.JwksBasedAuthentication
	(*JwksAuthProvider)(nil),                                 // 16: wgpb.JwksAuthProvider
	(*ApiAuthenticationHooks)(nil),                           // 17: wgpb.ApiAuthenticationHooks
	(*CookieBasedAuthentication)(nil),                        // 18: wgpb.CookieBasedAuthentication
	(*AuthProvider)(nil),                                     // 19: wgpb.AuthProvider
	(*GithubAuthProviderConfig)(nil),                         // 20: wgpb.GithubAuthProviderConfig
	(*OpenIDConnectQueryParameter)(nil),                      // 21: wgpb.OpenIDConnectQueryParameter
	...
	(*ServerOptions)(nil),                                    // 68: wgpb.ServerOptions
	(*WebhookConfiguration)(nil),                             // 69: wgpb.WebhookConfiguration
	(*WebhookVerifier)(nil),                                  // 70: wgpb.WebhookVerifier
	(*CorsConfiguration)(nil),                                // 71: wgpb.CorsConfiguration
	(*ConfigurationVariable)(nil),                            // 72: wgpb.ConfigurationVariable
	nil,                                                      // 73: wgpb.FetchConfiguration.HeaderEntry
}
var file_wundernode_config_proto_depIdxs = []int32{
	18,  // 0: wgpb.ApiAuthenticationConfig.cookieBased:type_name -> wgpb.CookieBasedAuthentication
	17,  // 1: wgpb.ApiAuthenticationConfig.hooks:type_name -> wgpb.ApiAuthenticationHooks
	15,  // 2: wgpb.ApiAuthenticationConfig.jwksBased:type_name -> wgpb.JwksBasedAuthentication
	16,  // 3: wgpb.JwksBasedAuthentication.providers:type_name -> wgpb.JwksAuthProvider
	72,  // 4: wgpb.JwksAuthProvider.jwksUrl:type_name -> wgpb.ConfigurationVariable
	72,  // 5: wgpb.JwksAuthProvider.jwksJson:type_name -> wgpb.ConfigurationVariable
	72,  // 6: wgpb.JwksAuthProvider.userInfoEndpoint:type_name -> wgpb.ConfigurationVariable
	19,  // 7: wgpb.CookieBasedAuthentication.providers:type_name -> wgpb.AuthProvider
	72,  // 8: wgpb.CookieBasedAuthentication.authorizedRedirectUris:type_name -> wgpb.ConfigurationVariable
	72,  // 9: wgpb.CookieBasedAuthentication.authorizedRedirectUriRegexes:type_name -> wgpb.ConfigurationVariable
	72,  // 10: wgpb.CookieBasedAuthentication.hashKey:type_name -> wgpb.ConfigurationVariable
	72,  // 11: wgpb.CookieBasedAuthentication.blockKey:type_name -> wgpb.ConfigurationVariable
	72,  // 12: wgpb.CookieBasedAuthentication.csrfSecret:type_name -> wgpb.ConfigurationVariable
	0,   // 13: wgpb.AuthProvider.kind:type_name -> wgpb.AuthProviderKind
	20,  // 14: wgpb.AuthProvider.githubConfig:type_name -> wgpb.GithubAuthProviderConfig
	22,  // 15: wgpb.AuthProvider.oidcConfig:type_name -> wgpb.OpenIDConnectAuthProviderConfig
	72,  // 16: wgpb.GithubAuthProviderConfig.clientId:type_name -> wgpb.ConfigurationVariable
	72,  // 17: wgpb.GithubAuthProviderConfig.clientSecret:type_name -> wgpb.ConfigurationVariable
	72,  // 18: wgpb.OpenIDConnectQueryParameter.name:type_name -> wgpb.ConfigurationVariable
	72,  // 19: wgpb.OpenIDConnectQueryParameter.value:type_name -> wgpb.ConfigurationVariable
	72,  // 20: wgpb.OpenIDConnectAuthProviderConfig.issuer:type_name -> wgpb.ConfigurationVariable
	72,  // 21: wgpb.OpenIDConnectAuthProviderConfig.clientId:type_name -> wgpb.ConfigurationVariable
	72,  // 22: wgpb.OpenIDConnectAuthProviderConfig.clientSecret:type_name -> wgpb.ConfigurationVariable
	21,  // 23: wgpb.OpenIDConnectAuthProviderConfig.queryParameters:type_name -> wgpb.OpenIDConnectQueryParameter
	1,   // 24: wgpb.ApiCacheConfig.kind:type_name -> wgpb.ApiCacheKind
	24,  // 25: wgpb.ApiCacheConfig.inMemoryConfig:type_name -> wgpb.InMemoryCacheConfig
	25,  // 26: wgpb.ApiCacheConfig.redisConfig:type_name -> wgpb.RedisCacheConfig
	5,   // 27: wgpb.Operation.operationType:type_name -> wgpb.OperationType
	...
	29,  // 33: wgpb.Operation.variablesConfiguration:type_name -> wgpb.OperationVariablesConfiguration
	27,  // 34: wgpb.Operation.postResolveTransformations:type_name -> wgpb.PostResolveTransformation
	2,   // 35: wgpb.PostResolveTransformation.kind:type_name -> wgpb.PostResolveTransformationKind
	28,  // 36: wgpb.PostResolveTransformation.get:type_name -> wgpb.PostResolveGetTransformation
	30,  // 37: wgpb.OperationVariablesConfiguration.injectVariables:type_name -> wgpb.VariableInjectionConfiguration
	3,   // 38: wgpb.VariableInjectionConfiguration.variableKind:type_name -> wgpb.InjectVariableKind
	...
	4,   // 42: wgpb.ClaimConfig.claim:type_name -> wgpb.Claim
	...
	6,   // 46: wgpb.DataSourceConfiguration.kind:type_name -> wgpb.DataSourceKind
	...
	31,  // 60: wgpb.DataSourceCustom_GraphQL.hooksConfiguration:type_name -> wgpb.GraphQLDataSourceHooksConfiguration
	61,  // 61: wgpb.DataSourceCustom_GraphQL.customScalarTypeFields:type_name -> wgpb.SingleTypeField
	72,  // 62: wgpb.DataSourceCustom_Database.databaseURL:type_name -> wgpb.ConfigurationVariable
	61,  // 63: wgpb.DataSourceCustom_Database.jsonTypeFields:type_name -> wgpb.SingleTypeField
	72,  // 64: wgpb.DataSourceCustom_Static.data:type_name -> wgpb.ConfigurationVariable
	72,  // 65: wgpb.GraphQLSubscriptionConfiguration.url:type_name -> wgpb.ConfigurationVariable
	72,  // 66: wgpb.FetchConfiguration.url:type_name -> wgpb.ConfigurationVariable
	9,   // 67: wgpb.FetchConfiguration.method:type_name -> wgpb.HTTPMethod
	73,  // 68: wgpb.FetchConfiguration.header:type_name -> wgpb.FetchConfiguration.HeaderEntry
	72,  // 69: wgpb.FetchConfiguration.body:type_name -> wgpb.ConfigurationVariable
	...
	72,  // 73: wgpb.FetchConfiguration.baseUrl:type_name -> wgpb.ConfigurationVariable
	72,  // 74: wgpb.FetchConfiguration.path:type_name -> wgpb.ConfigurationVariable
	72,  // 75: wgpb.MTLSConfiguration.key:type_name -> wgpb.ConfigurationVariable
	72,  // 76: wgpb.MTLSConfiguration.cert:type_name -> wgpb.ConfigurationVariable
	7,   // 77: wgpb.UpstreamAuthentication.kind:type_name -> wgpb.UpstreamAuthenticationKind
	53,  // 78: wgpb.UpstreamAuthentication.jwtConfig:type_name -> wgpb.JwtUpstreamAuthenticationConfig
	54,  // 79: wgpb.UpstreamAuthentication.jwtWithAccessTokenExchangeConfig:type_name -> wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange
	72,  // 80: wgpb.JwtUpstreamAuthenticationConfig.secret:type_name -> wgpb.ConfigurationVariable
	8,   // 81: wgpb.JwtUpstreamAuthenticationConfig.signingMethod:type_name -> wgpb.SigningMethod
	72,  // 82: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.secret:type_name -> wgpb.ConfigurationVariable
	8,   // 83: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.signingMethod:type_name -> wgpb.SigningMethod
	72,  // 84: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.accessTokenExchangeEndpoint:type_name -> wgpb.ConfigurationVariable
	72,  // 85: wgpb.HTTPHeader.values:type_name -> wgpb.ConfigurationVariable
	62,  // 86: wgpb.FieldConfiguration.argumentsConfiguration:type_name -> wgpb.ArgumentConfiguration
	10,  // 87: wgpb.ArgumentConfiguration.sourceType:type_name -> wgpb.ArgumentSource
	11,  // 88: wgpb.ArgumentConfiguration.renderConfiguration:type_name -> wgpb.ArgumentRenderConfiguration
	65,  // 89: wgpb.WunderGraphConfiguration.api:type_name -> wgpb.UserDefinedApi
	72,  // 90: wgpb.S3UploadConfiguration.endpoint:type_name -> wgpb.ConfigurationVariable
	72,  // 91: wgpb.S3UploadConfiguration.accessKeyID:type_name -> wgpb.ConfigurationVariable
	72,  // 92: wgpb.S3UploadConfiguration.secretAccessKey:type_name -> wgpb.ConfigurationVariable
	72,  // 93: wgpb.S3UploadConfiguration.bucketName:type_name -> wgpb.ConfigurationVariable
	72,  // 94: wgpb.S3UploadConfiguration.bucketLocation:type_name -> wgpb.ConfigurationVariable
	40,  // 95: wgpb.UserDefinedApi.engineConfiguration:type_name -> wgpb.EngineConfiguration
	26,  // 96: wgpb.UserDefinedApi.operations:type_name -> wgpb.Operation
	71,  // 97: wgpb.UserDefinedApi.corsConfiguration:type_name -> wgpb.CorsConfiguration
	14,  // 98: wgpb.UserDefinedApi.authenticationConfig:type_name -> wgpb.ApiAuthenticationConfig
	64,  // 99: wgpb.UserDefinedApi.s3UploadConfiguration:type_name -> wgpb.S3UploadConfiguration
	72,  // 100: wgpb.UserDefinedApi.allowedHostNames:type_name -> wgpb.ConfigurationVariable
	69,  // 101: wgpb.UserDefinedApi.webhooks:type_name -> wgpb.WebhookConfiguration
	68,  // 102: wgpb.UserDefinedApi.serverOptions:type_name -> wgpb.ServerOptions
	67,  // 103: wgpb.UserDefinedApi.nodeOptions:type_name -> wgpb.NodeOptions
	72,  // 104: wgpb.ListenerOptions.host:type_name -> wgpb.ConfigurationVariable
	72,  // 105: wgpb.ListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	72,  // 106: wgpb.NodeOptions.nodeUrl:type_name -> wgpb.ConfigurationVariable
	72,  // 107: wgpb.NodeOptions.publicNodeUrl:type_name -> wgpb.ConfigurationVariable
	66,  // 108: wgpb.NodeOptions.listen:type_name -> wgpb.ListenerOptions
	72,  // 109: wgpb.ServerOptions.serverUrl:type_name -> wgpb.ConfigurationVariable
	66,  // 110: wgpb.ServerOptions.listen:type_name -> wgpb.ListenerOptions
	70,  // 111: wgpb.WebhookConfiguration.verifier:type_name -> wgpb.WebhookVerifier
	12,  // 112: wgpb.WebhookVerifier.kind:type_name -> wgpb.WebhookVerifierKind
	72,  // 113: wgpb.WebhookVerifier.secret:type_name -> wgpb.ConfigurationVariable
	72,  // 114: wgpb.CorsConfiguration.allowedOrigins:type_name -> wgpb.ConfigurationVariable
	13,  // 115: wgpb.ConfigurationVariable.kind:type_name -> wgpb.ConfigurationVariableKind
