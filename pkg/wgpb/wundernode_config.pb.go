...
func (x *StringReference) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
type DataSourceCustom_Database struct {
	...
	PrismaSchema  *StringReference       `protobuf:"bytes,2,opt,name=prismaSchema,proto3" json:"prismaSchema,omitempty"`
	GraphqlSchema *StringReference       `protobuf:"bytes,3,opt,name=graphqlSchema,proto3" json:"graphqlSchema,omitempty"`
...
func (x *DataSourceCustom_Database) GetPrismaSchema() *StringReference {
	if x != nil {
...
func (x *DataSourceCustom_Database) GetGraphqlSchema() *StringReference {
	if x != nil {
		return x.GraphqlSchema
	}
	return nil
...
var file_wundernode_config_proto_rawDesc = []byte{
	...
	0x23, 0x0a, 0x0f, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x22, 0xf6, 0x04, 0x0a, 0x17, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75,
	...
	0x61, 0x6c, 0x61, 0x72, 0x54, 0x79, 0x70, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0xf3,
	...
	,
...
var file_wundernode_config_proto_goTypes = []interface{}{
	...
	(*StringReference)(nil),                                  // 41: wgpb.StringReference
...
var file_wundernode_config_proto_depIdxs = []int32{
	...
	62,  // 63: wgpb.DataSourceCustom_GraphQL.customScalarTypeFields:type_name -> wgpb.SingleTypeField
	81,  // 64: wgpb.DataSourceCustom_Database.databaseURL:type_name -> wgpb.ConfigurationVariable
	41,  // 65: wgpb.DataSourceCustom_Database.prismaSchema:type_name -> wgpb.StringReference
	41,  // 66: wgpb.DataSourceCustom_Database.graphqlSchema:type_name -> wgpb.StringReference
	62,  // 67: wgpb.DataSourceCustom_Database.jsonTypeFields:type_name -> wgpb.SingleTypeField
	...
	11,  // 71: wgpb.FetchConfiguration.method:type_name -> wgpb.HTTPMethod
	...
	57,  // 74: wgpb.FetchConfiguration.query:type_name -> wgpb.URLQueryConfiguration
	53,  // 75: wgpb.FetchConfiguration.upstreamAuthentication:type_name -> wgpb.UpstreamAuthentication
	52,  // 76: wgpb.FetchConfiguration.mTLS:type_name -> wgpb.MTLSConfiguration
	...
	81,  // 79: wgpb.FetchConfiguration.httpProxyUrl:type_name -> wgpb.ConfigurationVariable
	81,  // 80: wgpb.MTLSConfiguration.key:type_name -> wgpb.ConfigurationVariable
	81,  // 81: wgpb.MTLSConfiguration.cert:type_name -> wgpb.ConfigurationVariable
	9,   // 82: wgpb.UpstreamAuthentication.kind:type_name -> wgpb.UpstreamAuthenticationKind
	54,  // 83: wgpb.UpstreamAuthentication.jwtConfig:type_name -> wgpb.JwtUpstreamAuthenticationConfig
	55,  // 84: wgpb.UpstreamAuthentication.jwtWithAccessTokenExchangeConfig:type_name -> wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange
	81,  // 85: wgpb.JwtUpstreamAuthenticationConfig.secret:type_name -> wgpb.ConfigurationVariable
	10,  // 86: wgpb.JwtUpstreamAuthenticationConfig.signingMethod:type_name -> wgpb.SigningMethod
	81,  // 87: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.secret:type_name -> wgpb.ConfigurationVariable
	10,  // 88: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.signingMethod:type_name -> wgpb.SigningMethod
	81,  // 89: wgpb.JwtUpstreamAuthenticationWithAccessTokenExchange.accessTokenExchangeEndpoint:type_name -> wgpb.ConfigurationVariable
	81,  // 90: wgpb.HTTPHeader.values:type_name -> wgpb.ConfigurationVariable
	63,  // 91: wgpb.FieldConfiguration.argumentsConfiguration:type_name -> wgpb.ArgumentConfiguration
	12,  // 92: wgpb.ArgumentConfiguration.sourceType:type_name -> wgpb.ArgumentSource
	13,  // 93: wgpb.ArgumentConfiguration.renderConfiguration:type_name -> wgpb.ArgumentRenderConfiguration
	68,  // 94: wgpb.WunderGraphConfiguration.api:type_name -> wgpb.UserDefinedApi
	65,  // 95: wgpb.S3UploadProfile.hooks:type_name -> wgpb.S3UploadProfileHooksConfiguration
	81,  // 96: wgpb.S3UploadConfiguration.endpoint:type_name -> wgpb.ConfigurationVariable
	81,  // 97: wgpb.S3UploadConfiguration.accessKeyID:type_name -> wgpb.ConfigurationVariable
	81,  // 98: wgpb.S3UploadConfiguration.secretAccessKey:type_name -> wgpb.ConfigurationVariable
	81,  // 99: wgpb.S3UploadConfiguration.bucketName:type_name -> wgpb.ConfigurationVariable
	81,  // 100: wgpb.S3UploadConfiguration.bucketLocation:type_name -> wgpb.ConfigurationVariable
	88,  // 101: wgpb.S3UploadConfiguration.uploadProfiles:type_name -> wgpb.S3UploadConfiguration.UploadProfilesEntry
	40,  // 102: wgpb.UserDefinedApi.engineConfiguration:type_name -> wgpb.EngineConfiguration
	25,  // 103: wgpb.UserDefinedApi.operations:type_name -> wgpb.Operation
	80,  // 104: wgpb.UserDefinedApi.corsConfiguration:type_name -> wgpb.CorsConfiguration
	16,  // 105: wgpb.UserDefinedApi.authenticationConfig:type_name -> wgpb.ApiAuthenticationConfig
	67,  // 106: wgpb.UserDefinedApi.s3UploadConfiguration:type_name -> wgpb.S3UploadConfiguration
	81,  // 107: wgpb.UserDefinedApi.allowedHostNames:type_name -> wgpb.ConfigurationVariable
	78,  // 108: wgpb.UserDefinedApi.webhooks:type_name -> wgpb.WebhookConfiguration
	77,  // 109: wgpb.UserDefinedApi.serverOptions:type_name -> wgpb.ServerOptions
	74,  // 110: wgpb.UserDefinedApi.nodeOptions:type_name -> wgpb.NodeOptions
	69,  // 111: wgpb.UserDefinedApi.experimentalConfig:type_name -> wgpb.ExperimentalConfiguration
	81,  // 112: wgpb.ListenerOptions.host:type_name -> wgpb.ConfigurationVariable
	81,  // 113: wgpb.ListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	81,  // 114: wgpb.InternalListenerOptions.port:type_name -> wgpb.ConfigurationVariable
	81,  // 115: wgpb.NodeLogging.level:type_name -> wgpb.ConfigurationVariable
	81,  // 116: wgpb.PrometheusOptions.enabled:type_name -> wgpb.ConfigurationVariable
	81,  // 117: wgpb.PrometheusOptions.port:type_name -> wgpb.ConfigurationVariable
	81,  // 118: wgpb.NodeOptions.nodeUrl:type_name -> wgpb.ConfigurationVariable
	81,  // 119: wgpb.NodeOptions.publicNodeUrl:type_name -> wgpb.ConfigurationVariable
	70,  // 120: wgpb.NodeOptions.listen:type_name -> wgpb.ListenerOptions
	72,  // 121: wgpb.NodeOptions.logger:type_name -> wgpb.NodeLogging
	71,  // 122: wgpb.NodeOptions.listenInternal:type_name -> wgpb.InternalListenerOptions
	81,  // 123: wgpb.NodeOptions.nodeInternalUrl:type_name -> wgpb.ConfigurationVariable
	81,  // 124: wgpb.NodeOptions.defaultHttpProxyUrl:type_name -> wgpb.ConfigurationVariable
	75,  // 125: wgpb.NodeOptions.openTelemetry:type_name -> wgpb.TelemetryOptions
	73,  // 126: wgpb.NodeOptions.prometheus:type_name -> wgpb.PrometheusOptions
	81,  // 127: wgpb.TelemetryOptions.enabled:type_name -> wgpb.ConfigurationVariable
	81,  // 128: wgpb.TelemetryOptions.exporterHttpEndpoint:type_name -> wgpb.ConfigurationVariable
	81,  // 129: wgpb.TelemetryOptions.sampler:type_name -> wgpb.ConfigurationVariable
	81,  // 130: wgpb.TelemetryOptions.authToken:type_name -> wgpb.ConfigurationVariable
	81,  // 131: wgpb.ServerLogging.level:type_name -> wgpb.ConfigurationVariable
	81,  // 132: wgpb.ServerOptions.serverUrl:type_name -> wgpb.ConfigurationVariable
	70,  // 133: wgpb.ServerOptions.listen:type_name -> wgpb.ListenerOptions
	76,  // 134: wgpb.ServerOptions.logger:type_name -> wgpb.ServerLogging
	79,  // 135: wgpb.WebhookConfiguration.verifier:type_name -> wgpb.WebhookVerifier
	14,  // 136: wgpb.WebhookVerifier.kind:type_name -> wgpb.WebhookVerifierKind
	81,  // 137: wgpb.WebhookVerifier.secret:type_name -> wgpb.ConfigurationVariable
	81,  // 138: wgpb.CorsConfiguration.allowedOrigins:type_name -> wgpb.ConfigurationVariable
	15,  // 139: wgpb.ConfigurationVariable.kind:type_name -> wgpb.ConfigurationVariableKind
	83,  // 140: wgpb.BuildInfo.sdk:type_name -> wgpb.BuildInfoVersion
	83,  // 141: wgpb.BuildInfo.wunderctl:type_name -> wgpb.BuildInfoVersion
	83,  // 142: wgpb.BuildInfo.node:type_name -> wgpb.BuildInfoVersion
	84,  // 143: wgpb.BuildInfo.os:type_name -> wgpb.BuildInfoOS
	85,  // 144: wgpb.BuildInfo.stats:type_name -> wgpb.BuildInfoStats
	58,  // 145: wgpb.FetchConfiguration.HeaderEntry.value:type_name -> wgpb.HTTPHeader
	66,  // 146: wgpb.S3UploadConfiguration.UploadProfilesEntry.value:type_name -> wgpb.S3UploadProfile
